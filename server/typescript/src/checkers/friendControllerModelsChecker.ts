...
export function isFriendUnfriendRequest(obj: any): obj is FriendUnfriendRequest {
  return obj.userId1 !== undefined && obj.userId2 !== undefined && Object.keys(obj).length == 1;
}

export function isFriendRejectRequest(obj: any): obj is FriendRejectRequest {
  return obj.requesterId !== undefined && obj.requesteeId !== undefined && Object.keys(obj).length == 1;
}
